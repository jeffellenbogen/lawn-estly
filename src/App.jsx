...
// Custom Grass Icon Component for Header (2 Blades, Larger, Closer)
const GrassIcon = ({ className }) => (
  <svg 
    ...
    className={className}
  >
    {/* Left Blade: Taller, wider top, base moved closer to center */}
    <path d="M22 58 L 10 12 H 24 L 31 58 Z" />
    
    {/* Right Blade: Taller, wider top, base moved closer to center */}
    <path d="M33 58 L 38 18 H 52 L 42 58 Z" />
  </svg>
);
...
const FaviconManager = () => {
  useEffect(() => {
    // Custom Grass Icon (Monocot) - Updated Geometry
    const svg = `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none">
        <rect width="64" height="64" rx="16" fill="#ecfdf5"/>
        
        <!-- Left Blade -->
        <path d="M22 58 L 10 12 H 24 L 31 58 Z" fill="#059669" />
        
        <!-- Right Blade -->
        <path d="M33 58 L 38 18 H 52 L 42 58 Z" fill="#059669" />
      </svg>
    `.replace(/\n/g, '').replace(/#/g, '%23');
